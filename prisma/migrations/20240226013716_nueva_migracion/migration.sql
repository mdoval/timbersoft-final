/*
  ...
  - Added the required column `aserraderoId` to the `paquete` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `paquete` ADD COLUMN `aserraderoId` INTEGER NOT NULL;
