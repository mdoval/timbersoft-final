/*
  ...
  - Added the required column `aserraderoId` to the `tipo` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `tipo` ADD COLUMN `aserraderoId` INTEGER NOT NULL;
