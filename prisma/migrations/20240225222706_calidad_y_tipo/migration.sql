/*
  ...
  - Added the required column `calidadId` to the `paquete` table without a default value. This is not possible if the table is not empty.
  - Added the required column `tipoId` to the `paquete` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `paquete` ADD COLUMN `calidadId` INTEGER NOT NULL,
    ADD COLUMN `tipoId` INTEGER NOT NULL;

-- CreateTable
CREATE TABLE `tipo` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `catalogo` VARCHAR(191) NOT NULL,
