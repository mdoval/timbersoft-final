/*
  ...
  - Added the required column `aserraderoId` to the `destino` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `destino` ADD COLUMN `aserraderoId` INTEGER NOT NULL;
