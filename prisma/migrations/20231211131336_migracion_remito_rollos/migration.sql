/*
  ...
  - Added the required column `remitoId` to the `rollo` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `rollo` ADD COLUMN `remitoId` INTEGER NOT NULL;
